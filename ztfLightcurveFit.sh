#!/bin/bash
#SBATCH --job-name=ztfLightcurveFit
...
python3 /home/tbarna/dsmma_kn_23/scaledBandit_fit_only.py -m nugent-hyper Bu2019lm TrPi2018 -tm Bu2019lm --reward ucb --min-detections 7 --min-detections-cutoff 18 --nsteps 7 --outdir /expanse/lustre/projects/umn131/tbarna/ztfevalPaperlightcurves --nsamples 100 --ztf-sampling --tstep 2 
