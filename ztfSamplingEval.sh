...
python3 /home/tbarna/dsmma_kn_23/scaledBandit.py -m nugent-hyper Bu2019lm TrPi2018 -tm Bu2019lm --reward ucb --min-detections 8 --min-detections-cutoff 15 --nsteps 7 --outdir /expanse/lustre/projects/umn131/tbarna/ztfevalPaper/Bu2019lm --nsamples 100 --ztf-sampling --tstep 2 