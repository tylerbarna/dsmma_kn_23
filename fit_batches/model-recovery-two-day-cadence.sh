...
python3 ./requeue.py --test-run --root-dir /expanse/lustre/projects/umn131/tbarna/model-recovery-two-day-cadence-fits --output-file ./failures/model-recovery-two-day-cadence-failures --stats
